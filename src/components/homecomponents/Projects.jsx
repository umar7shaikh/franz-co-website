  ...
  const projects = [
    {
      ...
      quote: 'TranCo delivered a gym that became our project\'s biggest USP. Prospective buyers now expect this level of amenity in all our properties.',
      author: 'Nitin Shah',
    ...
    },
    {
      ...
      quote: 'The fitness center has become a major selling point. Our buyers specifically mention this amenity as a deciding factor.',
      author: 'Rajesh Kumar',
    ...
    },
    {
      ...
      quote: 'Outstanding execution and quality. The gym facility has exceeded our expectations and delighted our residents.',
      author: 'Anita Sharma',
      ...
      >
        ...
        >
          ...
          <div className="flex justify-between items-center mt-3">
            ...
            {/* Buttons aligned with description */}
        ...
        {/* Carousel Container - Extended Width with Swipe */}
        <div 
          className="relative"
          style={{
            width: '100vw',
        ...
        >
          ...
          <div className="flex gap-6 items-start">
            <blockquote 
              className="font-poppins italic flex-1"
              style={{
                fontSize: '14px',
                fontWeight: 400,
                lineHeight: '150%',
            ...
            <div className="flex gap-3">
              ...
              >
                <svg className="w-5 h-5" style={{ color: '#C34A36' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
