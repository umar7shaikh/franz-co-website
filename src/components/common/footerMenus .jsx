...
const Footer = () => (
  ...
  >
    ...
    >
      {/* Logo */}
      <div style={{ flex: "0 0 120px", fontFamily: "cursive", fontWeight: 600, fontSize: 26, marginRight: 10, marginTop: 3 }}>
        Logo
      ...
      >
        {footerMenus.map(menu => (
          <div key={menu.heading} style={{ minWidth: 130 }}>
            <div
              style={{
                color: "#C34A36",
                fontWeight: 600,
    ...
    >
      ...
      <div style={{ display: "flex", gap: 11, fontSize: 13, color: "#A6735B" }}>
        <a href="http://localhost:5173/" style={{ color: "inherit", textDecoration: "underline" }}>Privacy policy</a>
        <a href="http://localhost:5173/" style={{ color: "inherit", textDecoration: "underline" }}>Terms of service</a>
        <a href="http://localhost:5173/" style={{ color: "inherit", textDecoration: "underline" }}>Cookie settings</a>
      </div>
      <div style={{ display: "flex", gap: 12, fontSize: 18, marginTop: 4 }}>
