      ...
      <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row gap-10 items-center commitment-main-container">
        ...
        <div className="flex-1 flex flex-col items-start justify-center commitment-content">
          ...
          <div className="flex gap-4 mt-2 commitment-buttons">
            <button className="bg-white text-[#C34A36] px-5 py-2 font-poppins font-semibold text-sm rounded transition hover:bg-[#F6E0D8] commitment-primary-btn">
              Services
            </button>
            <button className="text-white font-poppins font-semibold text-sm inline-flex items-center gap-1 commitment-secondary-btn">
