          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col bg-white rounded-2xl shadow overflow-hidden h-[600px] sm:h-auto">
              ...
              <div className="p-8 flex flex-col flex-1">
                ...
                <div className="flex items-center gap-4 mt-auto">
                  <button 
                    className="text-[#C34A36] font-poppins font-medium text-[15px] hover:text-[#A63D36] transition-colors flex items-center gap-2"
            ...
            <div className="flex bg-white rounded-2xl shadow overflow-hidden h-[340px] sm:flex-col sm:h-auto">
              ...
              <div className="p-6 flex flex-col justify-between flex-1">
                ...
                <button 
                  className="text-[#C34A36] font-poppins font-medium text-[15px] hover:text-[#A63D36] transition-colors flex items-center gap-2 self-start sm:self-auto"
                  onClick={handleEnquireClick}
                >
                  Enquire <ArrowRight size={16} />
                </button>
